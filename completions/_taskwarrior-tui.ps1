...
Register-ArgumentCompleter -Native -CommandName 'taskwarrior-tui' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'taskwarrior-tui' {
            ...
            [CompletionResult]::new('-p', '-p', [CompletionResultType]::ParameterName, 'Selects a configured Taskwarrior profile')
            [CompletionResult]::new('--profile', '--profile', [CompletionResultType]::ParameterName, 'Selects a configured Taskwarrior profile')
            ...
            [CompletionResult]::new('--list-profiles', '--list-profiles', [CompletionResultType]::ParameterName, 'Lists configured Taskwarrior profiles and exits')
