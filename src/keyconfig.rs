...
impl KeyConfig {
  ...
  pub fn update(&mut self, data: &str) -> Result<()> {
    ...
    let profile_menu = Self::get_config("uda.taskwarrior-tui.keyconfig.profile-menu", data);
    ...
    self.profile_menu = profile_menu.unwrap_or(self.profile_menu);
